...
import com.example.springcloudsentence.domain.Sentence;
...
public class SentenceServiceImpl implements SentenceService {
    ...
    public String buildSentence() {
        ...
        List<Observable<Object[]>> observables = createObservables();
        ...
        Observable.merge(observables)
                .subscribe(
                        ...
                        (word) -> {
                            sentence.add(Role.valueOf(word[0].toString()), word[1].toString());
                            latch.countDown();
                        }
                );
    ...
    /**
     * Ultimately, we will need to wait for all 5 calls to be completed before
     * the sentence can be assembled. This code waits for the last call to come
     * back:
     */
    ...
    /**
     * This code launches calls to all 5 child services, using Observables to
     * monitor the completion:
     */
    private List<Observable<Object[]>> createObservables() {
